    ...
    return (
        <div className="md:w-1/2 lg:w-2/5 mx-5">
            ...
            <form
                ...
                <div className="mb-5">
                    <label htmlFor="alta" className="block text-gray-600 uppercase font-bold">
                        Alta</label>
                    <input
                        id="emaltaail"
                        type="date"
                ...
                <input
                    type="submit"
                    className="bg-indigo-600 w-full p-3 text-white uppercase font-bold hover:bg-indigo-400 cursor-pointer transition-shadow"
